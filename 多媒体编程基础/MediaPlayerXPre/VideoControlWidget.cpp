...
void VideoControlWidget::forword()
{
    if (mediaPlayer == nullptr)
        return;
    auto new_postion = mediaPlayer->position() + m_fwbfStepLength;
...
void VideoControlWidget::setfwbfStepLength(int value)
{
    m_fwbfStepLength = value;
}

int VideoControlWidget::fwbfStepLength() const
{
    return m_fwbfStepLength;
}

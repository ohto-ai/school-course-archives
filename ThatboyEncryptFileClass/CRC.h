...
template <typename TYPE>
TYPE CRC<TYPE>::crcCompute(const unsigned char* message, unsigned int nBytes)
{
    unsigned int offset;
    unsigned char byte;
...
template <typename TYPE>
TYPE CRC<TYPE>::crcCompute(const unsigned char* message, unsigned int nBytes, bool reinit)
{
    unsigned int offset;
    unsigned char byte;
    if (reinit)
